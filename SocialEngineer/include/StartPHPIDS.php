...
//        'REQUEST' => $_REQUEST,
    ...
    $init = IDS_Init::init($PHPIDS_LIB .'/IDS/Config/Config.ini');
//    $init = IDS_Init::init(dirname(__FILE__) . $PHPIDS_LIB .'/IDS/Config/Config.ini');
    ...
    $init->config['General']['base_path'] =  $PHPIDS_LIB .'/IDS/';
...
//        echo $result;
        ...
        */
        ...
        $warnning =  "Hacking attempt detected and logged.\n\n                                                  --Random";
        print GenJsonData("error",$warnning,0);
		exit;

    } else {
  //      echo '<a href="?test=%22><script>eval(window.name)</script>">click for an example attack</a>'.
//			'  <a href="ViewIDSLog.php">view log</a><br>';
    }
} catch (Exception $e) {
    /*
